...
/////////////////////////////////////////
    ...
    $fields2 = $fields;
	$fields2['L_PAYMENTREQUEST_0_NAME0'] = "YourSiteHere.com";
	$fields2['L_PAYMENTREQUEST_0_AMT0'] = $fields['PAYMENTREQUEST_0_ITEMAMT'];
 
////////////////////////////////////////


        $this->result = $paypal_lib->makeCall($this->getAPIURL(), $this->getAPIScript(), $this->method, $fields2, $this->method_version);
...
$total = $total + Tools::ps_round((Tools::ps_round($product['price_wt'],3 )* $product['quantity']),2);	
        }
    }
...
//            $fields['PAYMENTREQUEST_0_ITEMAMT'] = Tools::ps_round($total, $this->decimals) + Tools::ps_round($shipping_cost_wt, $this->decimals);
    ...
    public function rightPaymentProcess()
    {
        ...
        $absolute_difference_of_totals = abs($this->result['PAYMENTINFO_0_AMT'] - $total);

              if ( $absolute_difference_of_totals > 1 ){  // EAN H APOKLYSH STROGGYLOPOIHSHS EINAI > 1 EURO -> RETURN FALSE!
                return false;
              }
